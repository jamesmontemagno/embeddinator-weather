...
/** Class XAMWeatherFetcher
 *  Corresponding .NET Qualified Name: `XAMWeatherFetcher, Weather, Version=1.0.6365.17310, Culture=neutral, PublicKeyToken=null`
 */
...
/** Class XAMWeatherResult
 *  Corresponding .NET Qualified Name: `XAMWeatherResult, Weather, Version=1.0.6365.17310, Culture=neutral, PublicKeyToken=null`
 */
...
- (nullable instancetype)initWithTemp:(NSString *)temp text:(NSString *)text city:(NSString *)city state:(NSString *)state;
